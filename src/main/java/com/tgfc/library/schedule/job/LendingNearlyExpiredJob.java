...
public class LendingNearlyExpiredJob extends AbstractJob {
    @Autowired
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        Boolean success = mailService.batchTemplateMailing(list, JobTypeEnum.LENDING_NEARLY_EXPIRED.getCode());
